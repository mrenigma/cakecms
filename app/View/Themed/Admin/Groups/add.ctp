<div class="g_12">
	<div class="link_header">
		<?php echo $this->Html->link(__('List groups'), array('action' => 'view_admin'), array('class'=>'list') ); ?>
	</div>
	<div class="clear"></div>
	<div class="widget_header">
		<h4 class="widget_header_title wwIcon i_16_forms"><?php echo __('Add groups'); ?></h4>
	</div>
