<div class="g_12">
	<?php if($this->Session->read('Auth.User.Group.id') == 1): ?>
		<div class="link_header">
			...
			<?php echo $this->Form->postLink(__('Delete user'), array('action' => 'delete', $this->Form->value('User.id')), null, __('Want to delete this user?'), array('class'=>'add') ); ?>
		</div>
	<?php endif; ?>
	<div class="clear"></div>
	...
	<div class="widget_contents noPadding">
		<?php echo $this->Form->create('User'); ?>
			...
			<div class="line_grid">
				...
				<div class="g_9">
					<?php echo $this->Form->input('password', array('label' => false,'type'=> 'password','class' => 'simple_field')); ?>
			...
			<div class="line_grid">
				<div class="g_3"><span class="label">Flickr</span></div>
				<div class="g_9">
					<?php echo $this->Form->input('flickr', array('label' => false, 'class' => 'simple_field')); ?>
				</div>
			</div>
			<div class="line_grid">
				<div class="g_3">
